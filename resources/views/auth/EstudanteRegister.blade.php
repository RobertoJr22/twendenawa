...
@section('content')
<form method="POST" action="{{ route('RegistarEstudante') }}">
    @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="escolas_id" id="escolas_id" class="form-select" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="rotas_id" id="rotas_id" class="form-select" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="turnos_id" id="turnos_id" class="form-select" required>
